...
const Chat = () => {
  ...
  const quickQuestions = [
    "How did I do today with my nutrition goals?",
    "What should I eat for my next meal?",
    "Show me my nutrition progress for this week",
    "How can I better balance my macronutrients?",
  ...
  return (
    <div className="flex flex-col h-screen bg-background">
      {/* Header */}
      <div className="border-b border-border/40 p-4 bg-background/95 backdrop-blur">
