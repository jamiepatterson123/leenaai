      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr,300px] gap-6">
        ...
        <div className="order-2 md:order-2 space-y-6">
          ...
          <div className="px-4 md:px-0">
            <ImageAnalysisSection analyzing={analyzing} setAnalyzing={setAnalyzing} nutritionData={nutritionData} setNutritionData={setNutritionData} selectedDate={selectedDate} />
          </div>
        </div>
      </div>
    </div>;
