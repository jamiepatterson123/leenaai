    ...
    <div className="space-y-1.5">
      ...
      {food.nutrition && (
        <div className="text-sm text-muted-foreground space-x-2">
          ...
          <span>•</span>
          <span>{food.nutrition.carbs.toFixed(1)}g carbs</span>
          <span>•</span>
          <span>{food.nutrition.fat.toFixed(1)}g fat</span>
        </div>
      )}
    </div>
    <div className="flex items-center justify-end gap-3">
      {food.nutrition && (
        <span className="text-sm font-medium">{food.nutrition.calories.toFixed(1)} kcal</span>
      )}
      <DropdownMenu>
